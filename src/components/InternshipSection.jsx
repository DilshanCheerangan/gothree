      ...
      <div className={`w-full max-w-[1400px] flex flex-col md:flex-row items-center gap-16 md:gap-32 ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
        ...
        <div className="flex-1 text-left z-10">
          <motion.p
            ...
            className="font-inter text-brand-accent tracking-[0.35em] text-xs uppercase mb-6"
          >
            {data.tagline}
          </motion.p>
          ...
          >
            <span className="font-space uppercase tracking-[0.2em] text-xs">Enter Module</span>
