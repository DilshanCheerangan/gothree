    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full pointer-events-none select-none overflow-hidden h-[30vw] z-0">
        <motion.div
          ...
          className="absolute top-0 left-0 w-screen text-center text-[24.5vw] font-black text-brand-accent/[0.04] leading-none tracking-[-0.08em] whitespace-nowrap -translate-x-[0.6vw] -translate-y-[2.8vw]"
        >
          GOTHREE
        </motion.div>
      </div>
