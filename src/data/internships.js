export const internships = [
  {
    ...
    curriculum: [
      "Execute high-fidelity penetration tests on production-grade architectures.",
      "Architect and ship resilient defense layers for web systems and enterprise networks.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Real-time Physics Engineering",
      "High-Fidelity Rendering"
    ],
    curriculum: [
      "Architect spatial interactions and physics-driven mechanics within industry-standard engines.",
      "Ship a high-fidelity immersive world that pushes the limits of real-time rendering.",
  ...
  },
  {
    ...
    curriculum: [
      "Engineer high-concurrency automation systems for industrial-scale workflows.",
      "Ship a resilient, multi-module backend infrastructure with complex data orchestration.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Resilient Database Deployment"
    ],
    curriculum: [
      "Architect and deploy a mission-critical full-stack ecosystem using the modern stack.",
      "Engineer production-grade REST and GraphQL endpoints with industrial-scale resilience.",
  ...
  },
  {
    ...
    curriculum: [
      "Build and ship high-performance mobile architectures for global deployment.",
      "Master complex state management and gesture-driven interface logic.",
  ...
  },
  {
    ...
    curriculum: [
      "Architect neural networks that solve complex pattern-recognition challenges.",
      "Ship high-accuracy machine learning pipelines trained on verified industrial data.",
