...
export default function Contact() {
  return (
    <section id="contact" className="w-full min-h-screen flex flex-col justify-center items-center py-32 px-8 bg-blue-100 dark:bg-amber-100 relative z-10">
      ...
      <div className="max-w-3xl w-full text-center mb-16 px-4">
        <motion.span 
          ...
          viewport={{ once: true }}
          className="font-inter text-brand-accent tracking-[0.35em] text-xs uppercase mb-6 block font-bold"
        >
          Final Step
        </motion.span>
        ...
        <motion.h2 
          ...
          className="display-font text-5xl md:text-7xl font-light text-black dark:text-white leading-tight"
        >
          Start Your <br className="md:hidden" />
          <em className="italic font-bold text-blue-600 dark:text-amber-600 tracking-tight">Journey</em>
        </motion.h2>
        ...
        <motion.p 
          ...
          className="font-inter text-gray-700 dark:text-gray-300 font-light mt-6 text-lg tracking-tight"
        >
        ...
        >
          ...
          >
            ...
            <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-black dark:text-white">Join the Community WhatsApp</span>
      ...
      <div className="mt-32 flex flex-col items-center gap-6 text-brand-mist pb-16">
        <img src="/logoG.svg" alt="GoThree Logo" className="w-10 h-10 opacity-60 invert brightness-0" />
